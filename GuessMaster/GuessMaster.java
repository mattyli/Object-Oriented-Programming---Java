...
public class GuessMaster {
    ...
    public static void main(String[] args){
        ...
        Entity QU = new Entity("QU", new Date("December", 4, 1776));
        Entity usa1 = new Entity("United States", new Date("September", 4, 1776));
        Entity usa2 = new Entity("United States", new Date("June", 4, 1776));
        Entity usa3 = new Entity("United States", new Date("August", 4, 1776));
        Entity usa4 = new Entity("United States", new Date("May", 4, 1776));
